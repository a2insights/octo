...
class NewsLetterPolicy
{
    ...
    {
        return $user->can('force_delete_newsletter');
    }
    ...
    {
        return $user->can('force_delete_any_newsletter');
    }
    ...
    {
        return $user->can('restore_newsletter');
    }
    ...
    {
        return $user->can('restore_any_newsletter');
    }
    ...
    {
        return $user->can('replicate_newsletter');
    }
    ...
    {
        return $user->can('reorder_newsletter');
    }
}

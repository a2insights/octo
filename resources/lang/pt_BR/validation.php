...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'reward_coupon' => 'vale recompensa',
        'reward_id'     => 'recompensa',
        'points'        => 'pontos',

        'date_start'              => 'data de início',
        'date_end'                => 'data de fim',
        'date_config.hours.start' => 'horário do dia',
        'date_config.hours.end'   => 'horário do dia',
        'date_config.days'        => 'dias da semana',
        'date_config.days.*'      => 'dias da semana',

        'starts_at' => 'data de início',
        'ends_at'   => 'data de fim',

        'requirement_id'     => 'requisitos', // @deprecated
        'requirement_ids.*'  => 'requisitos',
        'segmentation_ids.*' => 'segmentações',
    ],
];
